...
namespace RS.Services.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(RSDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new RSException($"Cannot find a product: {productId}");
        ...
        public async Task<ProductReviewViewModel> GetReviewById(int reviewId)
        {
            ...
            if (review == null)
                throw new RSException($"Cannot find an review with id {reviewId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new RSException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new RSException($"Cannot find a product with id: {productId}");
