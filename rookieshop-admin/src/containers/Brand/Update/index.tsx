  ...
  useEffect(() => {
    ...
    if (existBrand) {
      setBrand({
        ...
        Price: existBrand.Price,
        OriginalPrice: existBrand.OriginalPrice,
        Stock: existBrand.Stock,
        Description: existBrand.Description,
        Details: existBrand.Details,
        SeoDescription: existBrand.SeoDescription,
        SeoTitle: existBrand.SeoTitle,
        SeoAlias: existBrand.SeoAlias,
        LanguageId: existBrand.LanguageId
      });
    }
  }, [existBrand]);
